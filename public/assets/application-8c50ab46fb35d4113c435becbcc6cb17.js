...
//# sourceMappingURL=/assets/source_maps/bundler/gems/turbolinks-1.3.0/lib/assets/javascripts/turbolinks.map
;
(function() {
...
//# sourceMappingURL=/assets/source_maps/app/assets/javascripts/location.map
;
...
(function() {
  $(document).ready(function() {
    var opts, target;
    $(".send_sms").on("ajax:success", function(e, data, status, xhr) {
      return $(".alert-box").append(xhr.responseText);
    }).bind("ajax:error", function(e, xhr, status, error) {
      return $(".alert-box").append("<p>Something's gone wrong</p>");
    });
    opts = {
      lines: 17,
      length: 0,
